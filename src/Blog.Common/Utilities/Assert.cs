...
namespace Blog.Common.Utilities;
...
public static class Assert
{
    ...
    public static void NotNullAny<Tk>(Tk? obj, string name, string message = null)
    {
        if (obj is null)
            throw new ArgumentNullException($"{name} : {typeof(Tk)}", message);
    }
